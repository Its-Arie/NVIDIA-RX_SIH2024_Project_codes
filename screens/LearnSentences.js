...
const LearnSentences = () => {
  return (
    <View style={styles.learnSentences}>
      <Image
        style={styles.learnSentencesChild}
        resizeMode="cover"
      ...
      />
      <Image
        style={[styles.learnSentencesItem, styles.learnPosition]}
        resizeMode="cover"
        source={require("../assets/rectangle-1442.png")}
      />
      <View style={[styles.learnSentencesInner, styles.learnPosition]} />
      <Text style={[styles.writeHere, styles.remarkFlexBox]}>Write Here</Text>
      <CardCardImage signToText="Sentences" propWidth={105} />
      <GroupComponent2 />
      <BaseMenuNavigation
        icon1={require("../assets/arrowcircleleft.png")}
        writngPad="વાક્યો શીખો (Learn Sentences)"
