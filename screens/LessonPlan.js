...
const LessonPlan = () => {
  ...
  return (
    <View style={styles.lessonPlan1}>
      <View style={styles.lessonPlan1Child} />
      <BaseUnitList2
      ...
      >
        <View style={styles.baseUnitListInner}>
          <View>
            <Text style={[styles.vowels, styles.textLayout]}>
              સ્વરો (Vowels)
            </Text>
          </View>
        </View>
      ...
      <Pressable
        style={[styles.baseUnitList2, styles.basePosition]}
