...
const LessonPlan2 = () => {
  ...
  return (
    <View style={styles.lessonPlan5}>
      ...
      <BaseUnitList
        prop="અ : a "
        iconactiondoneOutline24px={require("../assets/iconactiondone-outline-24px1.png")}
      />
      <BaseUnitList3
        ka="ક : ka"
      ...
      <View style={styles.cardCardImage}>
        <View style={styles.baseVideoPlayer}>
          <Image
            ...
            resizeMode="cover"
            source={require("../assets/frame-305.png")}
          />
          <Image
            style={[styles.baseVideoPlayerItem, styles.baseLayout]}
            resizeMode="cover"
            source={require("../assets/frame-3051.png")}
          />
        </View>
      </View>
      <BaseMenuNavigation1 vowels="સ્વરો (Vowels)" prop="અ : a " />
      <Base />
    </View>
  );
};
